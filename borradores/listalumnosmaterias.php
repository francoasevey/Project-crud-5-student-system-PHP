...
<body>
  <div class="background">
    ...
    SELECT 
        alumnos.nombre, 
        alumnos.apellido, 
        mesas_examen.materia, 
        mesas_examen.fecha, 
        inscripciones.condicion_alumno, 
        inscripciones.asistencia, 
        inscripciones.nota 
    FROM 
        inscripciones
    JOIN 
        alumnos ON inscripciones.id_alumno = alumnos.id_alumno
    JOIN 
        mesas_examen ON inscripciones.id_mesa = mesas_examen.id_mesa
...
if (!($resultado = mysqli_query($link, $consulta))) {
    ...
    exit();
            ...
            $consulta_total = "SELECT COUNT(*) as total FROM inscripciones";
