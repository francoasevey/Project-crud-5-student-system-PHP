    ...
    <div class="d-flex justify-content-center">
      <div class="table-container">
        ...
        <input type="hidden" name="id" value="<?php echo $id_inscripcion; ?>">
          ...
          <div class="form-group row">
            <label for="fecha" class="col-sm-3 col-form-label">Fecha Inscripcion:</label>
            <div class="col-sm-9">
              <input type="date" class="form-control" id="fecha" name="fecha" readonly value="<?php echo $row[6] ?>">
            </div>
          </div>
          <div class="form-group row">
